<template>
  <div class="row">
    <div class="column column-full-width">
      ...
      <div class="row row-border-bottom" v-for="value in this.selectedRequest().cookies" :key="value._id">
        ...
        <div class="column column-data text-button" v-on:click="deleteRequestDetailItem({ detailItem: value, requestId: this.selectedRequest()._id, option: 'cookies'})">
          Delete
        </div>
      </div>
    </div>
