      ...
      <div class="row row-border-bottom" v-for="value in this.selectedData().headers" :key="value._id">
        <div class="column column-data column-uparrow-hidden">
          <input 
            ...
            @change="editActive('headers', value._id, $event)">
        </div>
        ...
        <div class="column column-data column-20">
          <select class="column-input-select border-hidden column-input-select-stretch" :value="value.valueType" v-on:input="editValueType('headers', value._id, $event)">
        ...
        <div class="column column-data column-20" v-if="value.valueType === 'storage'">
          <select class="column-input-select border-hidden column-input-select-stretch" :value="value.value" v-on:input="editValue('headers', value._id, $event)">
              <option
...
export default {
  ...
  methods: {
    ...mapMutations('table', ['editRequestDetailKey', 'editRequestDetailValue','editRequestDetailValueType','editRequestDetailActive','editRequestDetailActive']),
