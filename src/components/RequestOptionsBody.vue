    ...
    <div class="column column-full-width">
      ...
      <div class="row row-border-bottom" v-for="value in this.selectedData().body" :key="value._id">
        ...
        <div class="column column-data column-20">
          <select class="column-input-select column-input-select-stretch" :value="value.valueType" v-on:input="editValueType('body', value._id, $event)">
        ...
        <div class="column column-data column-20" v-if="value.valueType === 'storage'">
          <select class="column-input-select column-input-select-stretch" :value="value.value" v-on:input="editValue('body', value._id, $event)">
              <option
